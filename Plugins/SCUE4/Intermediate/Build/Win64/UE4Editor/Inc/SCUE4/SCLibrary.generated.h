...
#define Cheessy_Working_Copy_Plugins_SCUE4_Source_SCUE4_Private_Blueprints_SCLibrary_h_27_RPC_WRAPPERS \
 \
 ...
 \
	DECLARE_FUNCTION(execSCO_Pure_GetRotatorMinusEqualFSR) \
	{ \
		P_GET_STRUCT_REF(FRotator,Z_Param_Out_NR); \
		P_GET_STRUCT_REF(FSafeRotator,Z_Param_Out_FSR); \
		P_FINISH; \
		P_NATIVE_BEGIN; \
		*(FRotator*)Z_Param__Result=USCLibrary::SCO_Pure_GetRotatorMinusEqualFSR(Z_Param_Out_NR,Z_Param_Out_FSR); \
		P_NATIVE_END; \
	} \
 \
	DECLARE_FUNCTION(execSCO_Pure_GetRotatorPlusEqualFSR) \
	{ \
		P_GET_STRUCT_REF(FRotator,Z_Param_Out_NR); \
		P_GET_STRUCT_REF(FSafeRotator,Z_Param_Out_FSR); \
		P_FINISH; \
		P_NATIVE_BEGIN; \
		*(FRotator*)Z_Param__Result=USCLibrary::SCO_Pure_GetRotatorPlusEqualFSR(Z_Param_Out_NR,Z_Param_Out_FSR); \
		P_NATIVE_END; \
	} \
 \
 ...
 \
	DECLARE_FUNCTION(execSCO_Pure_GetSafeRotatorMinusEqualRotator) \
	{ \
		P_GET_STRUCT_REF(FSafeRotator,Z_Param_Out_FSR); \
		P_GET_STRUCT_REF(FRotator,Z_Param_Out_NR); \
		P_GET_STRUCT_REF(FRotator,Z_Param_Out_Output); \
		P_FINISH; \
		P_NATIVE_BEGIN; \
		*(FSafeRotator*)Z_Param__Result=USCLibrary::SCO_Pure_GetSafeRotatorMinusEqualRotator(Z_Param_Out_FSR,Z_Param_Out_NR,Z_Param_Out_Output); \
		P_NATIVE_END; \
	} \
 \
	DECLARE_FUNCTION(execSCO_Pure_GetSafeRotatorPlusEqualRotator) \
	{ \
		P_GET_STRUCT_REF(FSafeRotator,Z_Param_Out_FSR); \
		P_GET_STRUCT_REF(FRotator,Z_Param_Out_NR); \
		P_GET_STRUCT_REF(FRotator,Z_Param_Out_Output); \
		P_FINISH; \
		P_NATIVE_BEGIN; \
		*(FSafeRotator*)Z_Param__Result=USCLibrary::SCO_Pure_GetSafeRotatorPlusEqualRotator(Z_Param_Out_FSR,Z_Param_Out_NR,Z_Param_Out_Output); \
		P_NATIVE_END; \
	} \
 \
 ...
 \
	DECLARE_FUNCTION(execSCO_Pure_GetSafeRotatorMinusEqualFSR) \
	{ \
		P_GET_STRUCT_REF(FSafeRotator,Z_Param_Out_FSR); \
		P_GET_STRUCT_REF(FSafeRotator,Z_Param_Out_SSR); \
		P_GET_STRUCT_REF(FRotator,Z_Param_Out_Output); \
		P_FINISH; \
		P_NATIVE_BEGIN; \
		*(FSafeRotator*)Z_Param__Result=USCLibrary::SCO_Pure_GetSafeRotatorMinusEqualFSR(Z_Param_Out_FSR,Z_Param_Out_SSR,Z_Param_Out_Output); \
		P_NATIVE_END; \
	} \
 \
	DECLARE_FUNCTION(execSCO_Pure_GetSafeRotatorPlusEqualFSR) \
	{ \
		P_GET_STRUCT_REF(FSafeRotator,Z_Param_Out_FSR); \
		P_GET_STRUCT_REF(FSafeRotator,Z_Param_Out_SSR); \
		P_GET_STRUCT_REF(FRotator,Z_Param_Out_Output); \
		P_FINISH; \
		P_NATIVE_BEGIN; \
		*(FSafeRotator*)Z_Param__Result=USCLibrary::SCO_Pure_GetSafeRotatorPlusEqualFSR(Z_Param_Out_FSR,Z_Param_Out_SSR,Z_Param_Out_Output); \
		P_NATIVE_END; \
	} \
 \
	DECLARE_FUNCTION(execSCO_Pure_GetSafeRotatorDecreaseFSR) \
	{ \
		P_GET_STRUCT_REF(FSafeRotator,Z_Param_Out_FSR); \
		P_GET_STRUCT_REF(FRotator,Z_Param_Out_Output); \
		P_FINISH; \
		P_NATIVE_BEGIN; \
		*(FSafeRotator*)Z_Param__Result=USCLibrary::SCO_Pure_GetSafeRotatorDecreaseFSR(Z_Param_Out_FSR,Z_Param_Out_Output); \
		P_NATIVE_END; \
	} \
 \
	DECLARE_FUNCTION(execSCO_Pure_GetSafeRotatorIncreaseFSR) \
	{ \
		P_GET_STRUCT_REF(FSafeRotator,Z_Param_Out_FSR); \
		P_GET_STRUCT_REF(FRotator,Z_Param_Out_Output); \
		P_FINISH; \
		P_NATIVE_BEGIN; \
		*(FSafeRotator*)Z_Param__Result=USCLibrary::SCO_Pure_GetSafeRotatorIncreaseFSR(Z_Param_Out_FSR,Z_Param_Out_Output); \
		P_NATIVE_END; \
	} \
 \
 ...
 \
	DECLARE_FUNCTION(execSCO_Pure_GetVector4DMinusEqualFSV) \
	{ \
		P_GET_STRUCT_REF(FVector4,Z_Param_Out_NV); \
		P_GET_STRUCT_REF(FSafeVector4D,Z_Param_Out_FSV); \
		P_FINISH; \
		P_NATIVE_BEGIN; \
		*(FVector4*)Z_Param__Result=USCLibrary::SCO_Pure_GetVector4DMinusEqualFSV(Z_Param_Out_NV,Z_Param_Out_FSV); \
		P_NATIVE_END; \
	} \
 \
	DECLARE_FUNCTION(execSCO_Pure_GetVector4DPlusEqualFSV) \
	{ \
		P_GET_STRUCT_REF(FVector4,Z_Param_Out_NV); \
		P_GET_STRUCT_REF(FSafeVector4D,Z_Param_Out_FSV); \
		P_FINISH; \
		P_NATIVE_BEGIN; \
		*(FVector4*)Z_Param__Result=USCLibrary::SCO_Pure_GetVector4DPlusEqualFSV(Z_Param_Out_NV,Z_Param_Out_FSV); \
		P_NATIVE_END; \
	} \
 \
 ...
 \
	DECLARE_FUNCTION(execSCO_Pure_GetSafeVector4DMinusEqualVector4D) \
	{ \
		P_GET_STRUCT_REF(FSafeVector4D,Z_Param_Out_FSV); \
		P_GET_STRUCT_REF(FVector4,Z_Param_Out_NV); \
		P_GET_STRUCT_REF(FVector4,Z_Param_Out_Output); \
		P_FINISH; \
		P_NATIVE_BEGIN; \
		*(FSafeVector4D*)Z_Param__Result=USCLibrary::SCO_Pure_GetSafeVector4DMinusEqualVector4D(Z_Param_Out_FSV,Z_Param_Out_NV,Z_Param_Out_Output); \
		P_NATIVE_END; \
	} \
 \
	DECLARE_FUNCTION(execSCO_Pure_GetSafeVector4DPlusEqualVector4D) \
	{ \
		P_GET_STRUCT_REF(FSafeVector4D,Z_Param_Out_FSV); \
		P_GET_STRUCT_REF(FVector4,Z_Param_Out_NV); \
		P_GET_STRUCT_REF(FVector4,Z_Param_Out_Output); \
		P_FINISH; \
		P_NATIVE_BEGIN; \
		*(FSafeVector4D*)Z_Param__Result=USCLibrary::SCO_Pure_GetSafeVector4DPlusEqualVector4D(Z_Param_Out_FSV,Z_Param_Out_NV,Z_Param_Out_Output); \
		P_NATIVE_END; \
	} \
 \
 ...
 \
	DECLARE_FUNCTION(execSCO_Pure_GetSafeVector4DMinusEqualFSV) \
	{ \
		P_GET_STRUCT_REF(FSafeVector4D,Z_Param_Out_FSV); \
		P_GET_STRUCT_REF(FSafeVector4D,Z_Param_Out_SSV); \
		P_GET_STRUCT_REF(FVector4,Z_Param_Out_Output); \
		P_FINISH; \
		P_NATIVE_BEGIN; \
		*(FSafeVector4D*)Z_Param__Result=USCLibrary::SCO_Pure_GetSafeVector4DMinusEqualFSV(Z_Param_Out_FSV,Z_Param_Out_SSV,Z_Param_Out_Output); \
		P_NATIVE_END; \
	} \
 \
	DECLARE_FUNCTION(execSCO_Pure_GetSafeVector4DPlusEqualFSV) \
	{ \
		P_GET_STRUCT_REF(FSafeVector4D,Z_Param_Out_FSV); \
		P_GET_STRUCT_REF(FSafeVector4D,Z_Param_Out_SSV); \
		P_GET_STRUCT_REF(FVector4,Z_Param_Out_Output); \
		P_FINISH; \
		P_NATIVE_BEGIN; \
		*(FSafeVector4D*)Z_Param__Result=USCLibrary::SCO_Pure_GetSafeVector4DPlusEqualFSV(Z_Param_Out_FSV,Z_Param_Out_SSV,Z_Param_Out_Output); \
		P_NATIVE_END; \
	} \
 \
	DECLARE_FUNCTION(execSCO_Pure_GetSafeVector4DDecreaseFSV) \
	{ \
		P_GET_STRUCT_REF(FSafeVector4D,Z_Param_Out_FSV); \
		P_GET_STRUCT_REF(FVector4,Z_Param_Out_Output); \
		P_FINISH; \
		P_NATIVE_BEGIN; \
		*(FSafeVector4D*)Z_Param__Result=USCLibrary::SCO_Pure_GetSafeVector4DDecreaseFSV(Z_Param_Out_FSV,Z_Param_Out_Output); \
		P_NATIVE_END; \
	} \
 \
	DECLARE_FUNCTION(execSCO_Pure_GetSafeVector4DIncreaseFSV) \
	{ \
		P_GET_STRUCT_REF(FSafeVector4D,Z_Param_Out_FSV); \
		P_GET_STRUCT_REF(FVector4,Z_Param_Out_Output); \
		P_FINISH; \
		P_NATIVE_BEGIN; \
		*(FSafeVector4D*)Z_Param__Result=USCLibrary::SCO_Pure_GetSafeVector4DIncreaseFSV(Z_Param_Out_FSV,Z_Param_Out_Output); \
		P_NATIVE_END; \
	} \
 \
 ...
 \
	DECLARE_FUNCTION(execSCO_Pure_GetVector3DMinusEqualFSV) \
	{ \
		P_GET_STRUCT_REF(FVector,Z_Param_Out_NV); \
		P_GET_STRUCT_REF(FSafeVector3D,Z_Param_Out_FSV); \
		P_FINISH; \
		P_NATIVE_BEGIN; \
		*(FVector*)Z_Param__Result=USCLibrary::SCO_Pure_GetVector3DMinusEqualFSV(Z_Param_Out_NV,Z_Param_Out_FSV); \
		P_NATIVE_END; \
	} \
 \
	DECLARE_FUNCTION(execSCO_Pure_GetVector3DPlusEqualFSV) \
	{ \
		P_GET_STRUCT_REF(FVector,Z_Param_Out_NV); \
		P_GET_STRUCT_REF(FSafeVector3D,Z_Param_Out_FSV); \
		P_FINISH; \
		P_NATIVE_BEGIN; \
		*(FVector*)Z_Param__Result=USCLibrary::SCO_Pure_GetVector3DPlusEqualFSV(Z_Param_Out_NV,Z_Param_Out_FSV); \
		P_NATIVE_END; \
	} \
 \
 ...
 \
	DECLARE_FUNCTION(execSCO_Pure_GetSafeVector3DMinusEqualVector3D) \
	{ \
		P_GET_STRUCT_REF(FSafeVector3D,Z_Param_Out_FSV); \
		P_GET_STRUCT_REF(FVector,Z_Param_Out_NV); \
		P_GET_STRUCT_REF(FVector,Z_Param_Out_Output); \
		P_FINISH; \
		P_NATIVE_BEGIN; \
		*(FSafeVector3D*)Z_Param__Result=USCLibrary::SCO_Pure_GetSafeVector3DMinusEqualVector3D(Z_Param_Out_FSV,Z_Param_Out_NV,Z_Param_Out_Output); \
		P_NATIVE_END; \
	} \
 \
	DECLARE_FUNCTION(execSCO_Pure_GetSafeVector3DPlusEqualVector3D) \
	{ \
		P_GET_STRUCT_REF(FSafeVector3D,Z_Param_Out_FSV); \
		P_GET_STRUCT_REF(FVector,Z_Param_Out_NV); \
		P_GET_STRUCT_REF(FVector,Z_Param_Out_Output); \
		P_FINISH; \
		P_NATIVE_BEGIN; \
		*(FSafeVector3D*)Z_Param__Result=USCLibrary::SCO_Pure_GetSafeVector3DPlusEqualVector3D(Z_Param_Out_FSV,Z_Param_Out_NV,Z_Param_Out_Output); \
		P_NATIVE_END; \
	} \
 \
 ...
 \
	DECLARE_FUNCTION(execSCO_Pure_GetSafeVector3DMinusEqualFSV) \
	{ \
		P_GET_STRUCT_REF(FSafeVector3D,Z_Param_Out_FSV); \
		P_GET_STRUCT_REF(FSafeVector3D,Z_Param_Out_SSV); \
		P_GET_STRUCT_REF(FVector,Z_Param_Out_Output); \
		P_FINISH; \
		P_NATIVE_BEGIN; \
		*(FSafeVector3D*)Z_Param__Result=USCLibrary::SCO_Pure_GetSafeVector3DMinusEqualFSV(Z_Param_Out_FSV,Z_Param_Out_SSV,Z_Param_Out_Output); \
		P_NATIVE_END; \
	} \
 \
	DECLARE_FUNCTION(execSCO_Pure_GetSafeVector3DPlusEqualFSV) \
	{ \
		P_GET_STRUCT_REF(FSafeVector3D,Z_Param_Out_FSV); \
		P_GET_STRUCT_REF(FSafeVector3D,Z_Param_Out_SSV); \
		P_GET_STRUCT_REF(FVector,Z_Param_Out_Output); \
		P_FINISH; \
		P_NATIVE_BEGIN; \
		*(FSafeVector3D*)Z_Param__Result=USCLibrary::SCO_Pure_GetSafeVector3DPlusEqualFSV(Z_Param_Out_FSV,Z_Param_Out_SSV,Z_Param_Out_Output); \
		P_NATIVE_END; \
	} \
 \
	DECLARE_FUNCTION(execSCO_Pure_GetSafeVector3DDecreaseFSV) \
	{ \
		P_GET_STRUCT_REF(FSafeVector3D,Z_Param_Out_FSV); \
		P_GET_STRUCT_REF(FVector,Z_Param_Out_Output); \
		P_FINISH; \
		P_NATIVE_BEGIN; \
		*(FSafeVector3D*)Z_Param__Result=USCLibrary::SCO_Pure_GetSafeVector3DDecreaseFSV(Z_Param_Out_FSV,Z_Param_Out_Output); \
		P_NATIVE_END; \
	} \
 \
	DECLARE_FUNCTION(execSCO_Pure_GetSafeVector3DIncreaseFSV) \
	{ \
		P_GET_STRUCT_REF(FSafeVector3D,Z_Param_Out_FSV); \
		P_GET_STRUCT_REF(FVector,Z_Param_Out_Output); \
		P_FINISH; \
		P_NATIVE_BEGIN; \
		*(FSafeVector3D*)Z_Param__Result=USCLibrary::SCO_Pure_GetSafeVector3DIncreaseFSV(Z_Param_Out_FSV,Z_Param_Out_Output); \
		P_NATIVE_END; \
	} \
 \
 ...
 \
	DECLARE_FUNCTION(execSCO_Pure_GetVector2DMinusEqualFSV) \
	{ \
		P_GET_STRUCT_REF(FVector2D,Z_Param_Out_NV); \
		P_GET_STRUCT_REF(FSafeVector2D,Z_Param_Out_FSV); \
		P_FINISH; \
		P_NATIVE_BEGIN; \
		*(FVector2D*)Z_Param__Result=USCLibrary::SCO_Pure_GetVector2DMinusEqualFSV(Z_Param_Out_NV,Z_Param_Out_FSV); \
		P_NATIVE_END; \
	} \
 \
	DECLARE_FUNCTION(execSCO_Pure_GetVector2DPlusEqualFSV) \
	{ \
		P_GET_STRUCT_REF(FVector2D,Z_Param_Out_NV); \
		P_GET_STRUCT_REF(FSafeVector2D,Z_Param_Out_FSV); \
		P_FINISH; \
		P_NATIVE_BEGIN; \
		*(FVector2D*)Z_Param__Result=USCLibrary::SCO_Pure_GetVector2DPlusEqualFSV(Z_Param_Out_NV,Z_Param_Out_FSV); \
		P_NATIVE_END; \
	} \
 \
 ...
 \
	DECLARE_FUNCTION(execSCO_Pure_GetSafeVector2DMinusEqualVector2D) \
	{ \
		P_GET_STRUCT_REF(FSafeVector2D,Z_Param_Out_FSV); \
		P_GET_STRUCT_REF(FVector2D,Z_Param_Out_NV); \
		P_GET_STRUCT_REF(FVector2D,Z_Param_Out_Output); \
		P_FINISH; \
		P_NATIVE_BEGIN; \
		*(FSafeVector2D*)Z_Param__Result=USCLibrary::SCO_Pure_GetSafeVector2DMinusEqualVector2D(Z_Param_Out_FSV,Z_Param_Out_NV,Z_Param_Out_Output); \
		P_NATIVE_END; \
	} \
 \
	DECLARE_FUNCTION(execSCO_Pure_GetSafeVector2DPlusEqualVector2D) \
	{ \
		P_GET_STRUCT_REF(FSafeVector2D,Z_Param_Out_FSV); \
		P_GET_STRUCT_REF(FVector2D,Z_Param_Out_NV); \
		P_GET_STRUCT_REF(FVector2D,Z_Param_Out_Output); \
		P_FINISH; \
		P_NATIVE_BEGIN; \
		*(FSafeVector2D*)Z_Param__Result=USCLibrary::SCO_Pure_GetSafeVector2DPlusEqualVector2D(Z_Param_Out_FSV,Z_Param_Out_NV,Z_Param_Out_Output); \
		P_NATIVE_END; \
	} \
 \
 ...
 \
	DECLARE_FUNCTION(execSCO_Pure_GetSafeVector2DMinusEqualFSV) \
	{ \
		P_GET_STRUCT_REF(FSafeVector2D,Z_Param_Out_FSV); \
		P_GET_STRUCT_REF(FSafeVector2D,Z_Param_Out_SSV); \
		P_GET_STRUCT_REF(FVector2D,Z_Param_Out_Output); \
		P_FINISH; \
		P_NATIVE_BEGIN; \
		*(FSafeVector2D*)Z_Param__Result=USCLibrary::SCO_Pure_GetSafeVector2DMinusEqualFSV(Z_Param_Out_FSV,Z_Param_Out_SSV,Z_Param_Out_Output); \
		P_NATIVE_END; \
	} \
 \
	DECLARE_FUNCTION(execSCO_Pure_GetSafeVector2DPlusEqualFSV) \
	{ \
		P_GET_STRUCT_REF(FSafeVector2D,Z_Param_Out_FSV); \
		P_GET_STRUCT_REF(FSafeVector2D,Z_Param_Out_SSV); \
		P_GET_STRUCT_REF(FVector2D,Z_Param_Out_Output); \
		P_FINISH; \
		P_NATIVE_BEGIN; \
		*(FSafeVector2D*)Z_Param__Result=USCLibrary::SCO_Pure_GetSafeVector2DPlusEqualFSV(Z_Param_Out_FSV,Z_Param_Out_SSV,Z_Param_Out_Output); \
		P_NATIVE_END; \
	} \
 \
	DECLARE_FUNCTION(execSCO_Pure_GetSafeVector2DDecreaseFSV) \
	{ \
		P_GET_STRUCT_REF(FSafeVector2D,Z_Param_Out_FSV); \
		P_GET_STRUCT_REF(FVector2D,Z_Param_Out_Output); \
		P_FINISH; \
		P_NATIVE_BEGIN; \
		*(FSafeVector2D*)Z_Param__Result=USCLibrary::SCO_Pure_GetSafeVector2DDecreaseFSV(Z_Param_Out_FSV,Z_Param_Out_Output); \
		P_NATIVE_END; \
	} \
 \
	DECLARE_FUNCTION(execSCO_Pure_GetSafeVector2DIncreaseFSV) \
	{ \
		P_GET_STRUCT_REF(FSafeVector2D,Z_Param_Out_FSV); \
		P_GET_STRUCT_REF(FVector2D,Z_Param_Out_Output); \
		P_FINISH; \
		P_NATIVE_BEGIN; \
		*(FSafeVector2D*)Z_Param__Result=USCLibrary::SCO_Pure_GetSafeVector2DIncreaseFSV(Z_Param_Out_FSV,Z_Param_Out_Output); \
		P_NATIVE_END; \
	} \
 \
 ...
 \
	DECLARE_FUNCTION(execSCO_Pure_GetStringPlusEqualFSS) \
	{ \
		P_GET_PROPERTY_REF(UStrProperty,Z_Param_Out_NS); \
		P_GET_STRUCT_REF(FSafeString,Z_Param_Out_FSS); \
		P_FINISH; \
		P_NATIVE_BEGIN; \
		*(FString*)Z_Param__Result=USCLibrary::SCO_Pure_GetStringPlusEqualFSS(Z_Param_Out_NS,Z_Param_Out_FSS); \
		P_NATIVE_END; \
	} \
 \
 ...
 \
	DECLARE_FUNCTION(execSCO_Pure_GetSafeStringPlusEqualString) \
	{ \
		P_GET_STRUCT_REF(FSafeString,Z_Param_Out_FSS); \
		P_GET_PROPERTY_REF(UStrProperty,Z_Param_Out_NS); \
		...
		P_FINISH; \
		P_NATIVE_BEGIN; \
		*(FSafeString*)Z_Param__Result=USCLibrary::SCO_Pure_GetSafeStringPlusEqualString(Z_Param_Out_FSS,Z_Param_Out_NS,Z_Param_Out_Output); \
		P_NATIVE_END; \
	} \
 \
 ...
 \
	DECLARE_FUNCTION(execSCO_Pure_GetSafeStringPlusEqualFSS) \
	{ \
		P_GET_STRUCT_REF(FSafeString,Z_Param_Out_FSS); \
		...
		P_FINISH; \
		P_NATIVE_BEGIN; \
		*(FSafeString*)Z_Param__Result=USCLibrary::SCO_Pure_GetSafeStringPlusEqualFSS(Z_Param_Out_FSS,Z_Param_Out_SS,Z_Param_Out_Output); \
		P_NATIVE_END; \
	} \
 \
 ...
 \
	DECLARE_FUNCTION(execSCO_Pure_GetTextPlusEqualFST) \
	{ \
		P_GET_PROPERTY_REF(UTextProperty,Z_Param_Out_NT); \
		P_GET_STRUCT_REF(FSafeText,Z_Param_Out_FST); \
		P_FINISH; \
		P_NATIVE_BEGIN; \
		*(FText*)Z_Param__Result=USCLibrary::SCO_Pure_GetTextPlusEqualFST(Z_Param_Out_NT,Z_Param_Out_FST); \
		P_NATIVE_END; \
	} \
 \
 ...
 \
	DECLARE_FUNCTION(execSCO_Pure_GetSafeTextPlusEqualText) \
	{ \
		P_GET_STRUCT_REF(FSafeText,Z_Param_Out_FST); \
		P_GET_PROPERTY_REF(UTextProperty,Z_Param_Out_NT); \
		...
		P_FINISH; \
		P_NATIVE_BEGIN; \
		*(FSafeText*)Z_Param__Result=USCLibrary::SCO_Pure_GetSafeTextPlusEqualText(Z_Param_Out_FST,Z_Param_Out_NT,Z_Param_Out_Output); \
		P_NATIVE_END; \
	} \
 \
 ...
 \
	DECLARE_FUNCTION(execSCO_Pure_GetSafeTextPlusEqualFST) \
	{ \
		P_GET_STRUCT_REF(FSafeText,Z_Param_Out_FST); \
		...
		P_FINISH; \
		P_NATIVE_BEGIN; \
		*(FSafeText*)Z_Param__Result=USCLibrary::SCO_Pure_GetSafeTextPlusEqualFST(Z_Param_Out_FST,Z_Param_Out_ST,Z_Param_Out_Output); \
		P_NATIVE_END; \
	} \
 \
 ...
 \
	DECLARE_FUNCTION(execSCO_Pure_GetNamePlusEqualFSN) \
	{ \
		P_GET_PROPERTY_REF(UNameProperty,Z_Param_Out_NN); \
		P_GET_STRUCT_REF(FSafeName,Z_Param_Out_FSN); \
		P_FINISH; \
		P_NATIVE_BEGIN; \
		*(FName*)Z_Param__Result=USCLibrary::SCO_Pure_GetNamePlusEqualFSN(Z_Param_Out_NN,Z_Param_Out_FSN); \
		P_NATIVE_END; \
	} \
 \
 ...
 \
	DECLARE_FUNCTION(execSCO_Pure_GetSafeNamePlusEqualName) \
	{ \
		P_GET_STRUCT_REF(FSafeName,Z_Param_Out_FSN); \
		P_GET_PROPERTY_REF(UNameProperty,Z_Param_Out_NN); \
		...
		P_FINISH; \
		P_NATIVE_BEGIN; \
		*(FSafeName*)Z_Param__Result=USCLibrary::SCO_Pure_GetSafeNamePlusEqualName(Z_Param_Out_FSN,Z_Param_Out_NN,Z_Param_Out_Output); \
		P_NATIVE_END; \
	} \
 \
 ...
 \
	DECLARE_FUNCTION(execSCO_Pure_GetSafeNamePlusEqualFSN) \
	{ \
		P_GET_STRUCT_REF(FSafeName,Z_Param_Out_FSN); \
		...
		P_FINISH; \
		P_NATIVE_BEGIN; \
		*(FSafeName*)Z_Param__Result=USCLibrary::SCO_Pure_GetSafeNamePlusEqualFSN(Z_Param_Out_FSN,Z_Param_Out_SSN,Z_Param_Out_Output); \
		P_NATIVE_END; \
	} \
 \
 ...
 \
	DECLARE_FUNCTION(execSCO_Pure_GetFloatMinusEqualFSF) \
	{ \
		P_GET_PROPERTY_REF(UFloatProperty,Z_Param_Out_NF); \
		P_GET_STRUCT_REF(FSafeFloat,Z_Param_Out_FSF); \
		P_FINISH; \
		P_NATIVE_BEGIN; \
		*(float*)Z_Param__Result=USCLibrary::SCO_Pure_GetFloatMinusEqualFSF(Z_Param_Out_NF,Z_Param_Out_FSF); \
		P_NATIVE_END; \
	} \
 \
	DECLARE_FUNCTION(execSCO_Pure_GetFloatPlusEqualFSF) \
	{ \
		P_GET_PROPERTY_REF(UFloatProperty,Z_Param_Out_NF); \
		P_GET_STRUCT_REF(FSafeFloat,Z_Param_Out_FSF); \
		P_FINISH; \
		P_NATIVE_BEGIN; \
		*(float*)Z_Param__Result=USCLibrary::SCO_Pure_GetFloatPlusEqualFSF(Z_Param_Out_NF,Z_Param_Out_FSF); \
		P_NATIVE_END; \
	} \
 \
 ...
 \
	DECLARE_FUNCTION(execSCO_Pure_GetIntMinusEqualFSI) \
	{ \
		P_GET_PROPERTY_REF(UIntProperty,Z_Param_Out_NI); \
		P_GET_STRUCT_REF(FSafeInt,Z_Param_Out_FSI); \
		P_FINISH; \
		P_NATIVE_BEGIN; \
		*(int32*)Z_Param__Result=USCLibrary::SCO_Pure_GetIntMinusEqualFSI(Z_Param_Out_NI,Z_Param_Out_FSI); \
		P_NATIVE_END; \
	} \
 \
	DECLARE_FUNCTION(execSCO_Pure_GetIntPlusEqualFSI) \
	{ \
		P_GET_PROPERTY_REF(UIntProperty,Z_Param_Out_NI); \
		P_GET_STRUCT_REF(FSafeInt,Z_Param_Out_FSI); \
		P_FINISH; \
		P_NATIVE_BEGIN; \
		*(int32*)Z_Param__Result=USCLibrary::SCO_Pure_GetIntPlusEqualFSI(Z_Param_Out_NI,Z_Param_Out_FSI); \
		P_NATIVE_END; \
	} \
 \
 ...
 \
	DECLARE_FUNCTION(execSCO_Pure_GetByteMinusEqualFSB) \
	{ \
		P_GET_PROPERTY_REF(UByteProperty,Z_Param_Out_NB); \
		P_GET_STRUCT_REF(FSafeByte,Z_Param_Out_FSB); \
		P_FINISH; \
		P_NATIVE_BEGIN; \
		*(uint8*)Z_Param__Result=USCLibrary::SCO_Pure_GetByteMinusEqualFSB(Z_Param_Out_NB,Z_Param_Out_FSB); \
		P_NATIVE_END; \
	} \
 \
	DECLARE_FUNCTION(execSCO_Pure_GetBytePlusEqualFSB) \
	{ \
		P_GET_PROPERTY_REF(UByteProperty,Z_Param_Out_NB); \
		P_GET_STRUCT_REF(FSafeByte,Z_Param_Out_FSB); \
		P_FINISH; \
		P_NATIVE_BEGIN; \
		*(uint8*)Z_Param__Result=USCLibrary::SCO_Pure_GetBytePlusEqualFSB(Z_Param_Out_NB,Z_Param_Out_FSB); \
		P_NATIVE_END; \
	} \
 \
...
#define Cheessy_Working_Copy_Plugins_SCUE4_Source_SCUE4_Private_Blueprints_SCLibrary_h_27_RPC_WRAPPERS_NO_PURE_DECLS \
 \
	DECLARE_FUNCTION(execSCO_Pure_SetTransformEqualFST) \
	{ \
		P_GET_STRUCT_REF(FTransform,Z_Param_Out_NT); \
...
#define Cheessy_Working_Copy_Plugins_SCUE4_Source_SCUE4_Private_Blueprints_SCLibrary_h_27_INCLASS_NO_PURE_DECLS \
	private: \
	static void StaticRegisterNativesUSCLibrary(); \
	friend SCUE4_API class UClass* Z_Construct_UClass_USCLibrary(); \
	public: \
	DECLARE_CLASS(USCLibrary, UBlueprintFunctionLibrary, COMPILED_IN_FLAGS(0), 0, TEXT("/Script/SCUE4"), NO_API) \
	DECLARE_SERIALIZER(USCLibrary) \
	/** Indicates whether the class is compiled into the engine */ \
	enum {IsIntrinsic=COMPILED_IN_INTRINSIC};


#define Cheessy_Working_Copy_Plugins_SCUE4_Source_SCUE4_Private_Blueprints_SCLibrary_h_27_INCLASS \
	private: \
	static void StaticRegisterNativesUSCLibrary(); \
	friend SCUE4_API class UClass* Z_Construct_UClass_USCLibrary(); \
	public: \
...
#define Cheessy_Working_Copy_Plugins_SCUE4_Source_SCUE4_Private_Blueprints_SCLibrary_h_27_STANDARD_CONSTRUCTORS \
...
#define Cheessy_Working_Copy_Plugins_SCUE4_Source_SCUE4_Private_Blueprints_SCLibrary_h_27_ENHANCED_CONSTRUCTORS \
	/** Standard constructor, called after all reflected properties have been initialized */ \
...
#define Cheessy_Working_Copy_Plugins_SCUE4_Source_SCUE4_Private_Blueprints_SCLibrary_h_27_PRIVATE_PROPERTY_OFFSET
#define Cheessy_Working_Copy_Plugins_SCUE4_Source_SCUE4_Private_Blueprints_SCLibrary_h_25_PROLOG
#define Cheessy_Working_Copy_Plugins_SCUE4_Source_SCUE4_Private_Blueprints_SCLibrary_h_27_GENERATED_BODY_LEGACY \
PRAGMA_DISABLE_DEPRECATION_WARNINGS \
public: \
	Cheessy_Working_Copy_Plugins_SCUE4_Source_SCUE4_Private_Blueprints_SCLibrary_h_27_PRIVATE_PROPERTY_OFFSET \
	Cheessy_Working_Copy_Plugins_SCUE4_Source_SCUE4_Private_Blueprints_SCLibrary_h_27_RPC_WRAPPERS \
	Cheessy_Working_Copy_Plugins_SCUE4_Source_SCUE4_Private_Blueprints_SCLibrary_h_27_INCLASS \
	Cheessy_Working_Copy_Plugins_SCUE4_Source_SCUE4_Private_Blueprints_SCLibrary_h_27_STANDARD_CONSTRUCTORS \
public: \
PRAGMA_ENABLE_DEPRECATION_WARNINGS


#define Cheessy_Working_Copy_Plugins_SCUE4_Source_SCUE4_Private_Blueprints_SCLibrary_h_27_GENERATED_BODY \
PRAGMA_DISABLE_DEPRECATION_WARNINGS \
public: \
	Cheessy_Working_Copy_Plugins_SCUE4_Source_SCUE4_Private_Blueprints_SCLibrary_h_27_PRIVATE_PROPERTY_OFFSET \
	Cheessy_Working_Copy_Plugins_SCUE4_Source_SCUE4_Private_Blueprints_SCLibrary_h_27_RPC_WRAPPERS_NO_PURE_DECLS \
	Cheessy_Working_Copy_Plugins_SCUE4_Source_SCUE4_Private_Blueprints_SCLibrary_h_27_INCLASS_NO_PURE_DECLS \
	Cheessy_Working_Copy_Plugins_SCUE4_Source_SCUE4_Private_Blueprints_SCLibrary_h_27_ENHANCED_CONSTRUCTORS \
private: \
PRAGMA_ENABLE_DEPRECATION_WARNINGS


#undef CURRENT_FILE_ID
#define CURRENT_FILE_ID Cheessy_Working_Copy_Plugins_SCUE4_Source_SCUE4_Private_Blueprints_SCLibrary_h
